  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-2 text-[var(--text-primary)]">Projects</h1>
        <p className="text-[var(--text-secondary)] mb-8">Things I&apos;ve built</p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {profile.projects.map((project, index) => (
            ...
            >
              ...
              <p className="text-[var(--text-secondary)] mb-4 flex-grow">{project.description}</p>
